<?php
    ...
    if (isset($_POST["universite"]) &&
        ...
        $ekle = mysqli_query($db, "INSERT INTO ".$databaseName." (universite, fakulte, unituru, sehir, ucret, siralamalar, kontenjanlar, unikodu) VALUES ('$universite', '$fakulte', '$unituru', '$sehir', '$ucret', '$siralamalar', '$kontenjanlar', '$unikodu')");
