...
<body>
    ...
    <h1 class="bg-dark text-white text-center py-4 rounded display-5 font-weight-bold">Yazılım Mühendisliği Bölümleri (2023-2019)</h1>
    ...
    <?php
        ...
        if ($action == 'sil' && $id) {
            $sil = mysqli_query($db, "DELETE FROM universiteler WHERE unikodu=$id");
            if ($sil) {
            ...
            $liste = mysqli_query($db, "SELECT * FROM universiteler WHERE unikodu=$id");
    ...
    <div class="d-flex align-items-center justify-content-between" style="padding: 10px;">
        ...
        <a class="btn btn-warning" href="favoriler.php">⭐️ Favoriler</a>
    </div>
    ...
    <div class="table-responsive my-4 rounded">
        <table class="table table-striped table-hover rounded">
            ...
            <tbody>
                <?php
                    $row_count = 0;
                    $liste = mysqli_query($db,"SELECT * FROM universiteler");
